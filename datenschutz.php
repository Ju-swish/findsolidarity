<?php session_start();
  require("config.php");
  $results['pageTitle'] = "Datenschutz | Find Solidarity";
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <p>Find Solidarity Team<br>Stefan-Meier-Str. 8<br>79104 Freiburg<br>Deutschland</span></p>
          <p>E-Mail: findsolidarity@gmail.com</p>
